...
Let's look at an example dataset (one I've purposely made).
...
lettersdf <- data.frame(letters = paste(LETTERS, rev(LETTERS), sep = "."), val = rnorm(length(LETTERS), 0, 5))
lettersdf %>%
...
TODO: Produce a good fake dataset with various issues

- odd values
- missing observations where we expect
- a full replication of the time series
...
TODO: Do a col with -999s in there
