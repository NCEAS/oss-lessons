...
pdfs <- list.files(path="/tmp/oil_spill_pdfs", pattern= 'pdf$',  full.names = TRUE) 
...
## Create the Corpus object needed for the text analysis
...
# Some stats about the 5 first journal articles
...
Want only articles before 2017?
...
***The above text manipulations are the necessary steps to enable more advance text analaysis, such as topical modeling and similarities between texts.***
