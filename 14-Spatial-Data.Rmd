...
![the R / Python learning curve](./images/learning-r.png)
...
![Geeks and automation](./images/DFRpdfrV0AEOm9z.jpg)
...
![Vector data types - points, lines and polygons](./images/points-lines-polygons-vector-data-types.png)
...
![About vector data extent](./images/spatial-extent.png)
...
![The human head projected](./images/human-head-projections.jpg)
...
![About raster data](./images/raster-concept.png)
...
![Raster resolution](./images/raster-resolution.png)

![Raster pixel resolution](./images/raster-pixel-resolution.png)
...
![Raster spatial extent](./images/raster-spatial-extent-coordinates.png)
...
![Raster pixel resolution](./images/raster-spatial-extent.png)
...
![QGIS plugins](./images/installpluginbuilder.png)
...
![Point, line OR polygon features can be stored within a vector dataset ](./images/points-lines-polygons-vector-data-types.png)
...
![Simplify vertices](./images/simplify.png)
...
![raster bands](./images/single-vs-multi-band-raster-data.png)
