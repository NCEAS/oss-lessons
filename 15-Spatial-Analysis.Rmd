...
![Extract data from a buffer](./images/buffer-circular.png)
...
```{r}
study_area <- readOGR("./data/study-area/study-area.shp")
# import climate data - netcdf format
climate <- raster("./data/climate/air.sfc.mon.mean.nc")
...
writeRaster(climate_geog_cr,
            filename = "./data/tues-data/climate_geog_cr.tif",
            "GTiff")
...
```{r}
# import vector data
sea_level_2000_sp <- readOGR("./data/tues-data/sea_level_2000.shp")
...
```{r}
# import csv file
sea_level_2000 <- read.csv("./data/tues-data/sea_lev_2000.csv")
