...
```{r, out.width = "70%", echo=FALSE, fig.align="center", fig.cap="Ecology of Infectious Disease"}
knitr::include_graphics("images/syn-inf-disease.png")
```

```{r, out.width = "70%", echo=FALSE, fig.align="center", fig.cap="Climate Effects"}
knitr::include_graphics("images/syn-climate-effects.png")
```

```{r, out.width = "70%", echo=FALSE, fig.align="center", fig.cap="Threats and Population Declines"}
knitr::include_graphics("images/syn-marine-systems.png")
```

```{r, out.width = "70%", echo=FALSE, fig.align="center", fig.cap="Understanding Ocean Health"}
...
```{r, out.width = "50%", echo=FALSE, fig.align="center", fig.cap="OHI Data"}
knitr::include_graphics("images/knb-ohi-global.png")
```

### Software

```{r, out.width = "50%", echo=FALSE, fig.align="center", fig.cap="OHI - Software"}
