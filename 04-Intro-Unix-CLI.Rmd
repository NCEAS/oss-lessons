...
![versions](./images/phd-datamanagement-story-filenames-052810s.png)
...
_[Pay no attention to that man behind the curtain](http://www.youtube.com/watch?v=YWyCCJ6B2WE)_
...
![Search for stuff](./images/rover.png)

_Like Rover, the Windows search dog. But more useful._
...
![](./images/xkcd-regex.png)

### What is a regular expression?

_Notation for describing a set of character strings_
...
_Matching patterns to text lets you..._
