...
```{r, out.width="10%", echo=FALSE, fig.align="right", fig.cap="Python logo"}
knitr::include_graphics("images/python.png")
```

## The Why 
```{r, out.width="80%", echo=FALSE, fig.align="right", fig.cap="Scripting languages"}
knitr::include_graphics("images/IEEE_spectrum.png")
```
